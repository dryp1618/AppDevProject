        ...
        <div class="main-container">
            <div class="main-border-box">
                ...
                <div class="input-area">
                    ...
                    <div class="entry-area">
                        <input type="number" id="regID" minlength="10" maxlength="11" required validate>
                    ...
                    <div class="entry-area">
                        <input type="number" id="phone" pattern="^0(9\d{9}|[2-8]\d{7,8})$" required pattern validate minlength="5" maxlength="11">
